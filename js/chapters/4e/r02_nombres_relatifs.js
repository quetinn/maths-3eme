// =====================================================================
//  r02_nombres_relatifs.js — 4ᵉ : additionner, soustraire,
...
export default {
  ...
  intro:
    "Les nombres relatifs (positifs et négatifs) servent à mesurer des températures, des dettes, " +
    "des altitudes… Surtout, maîtriser les <strong>règles des signes</strong> est indispensable en 3ᵉ : calcul " +
    "littéral, équations, fonctions… une erreur de signe et tout le calcul est faux. On travaille ici les quatre " +
