// =====================================================================
//  r12_aires_volumes.js — 4ᵉ : aires usuelles, périmètre,
...
export default {
  ...
  intro:
    ...
    "et indispensable en 3ᵉ (géométrie dans l'espace, homothétie). On travaille ici les formules d'aires usuelles, " +
  ...
  exercices: [
    ...
    },
    {
      ...
      generer() { const r = randInt(2, 7); return { enonce: `Disque de rayon $${r}$ cm. Aire (au dixième) ?`, reponse: r1(Math.PI * r * r), accepte: [r1(3.14 * r * r)], validation: 'nombre', tolerance: 0.05, _v: { r } }; },
