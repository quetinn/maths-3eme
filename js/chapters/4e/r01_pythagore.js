// =====================================================================
//  r01_pythagore.js — 4ᵉ : théorème de Pythagore et réciproque
...
export default {
  ...
  intro:
    "Le théorème de Pythagore relie les trois côtés d'un triangle <strong>rectangle</strong>. " +
  ...
  exercices: [
    ...
    // ----- Niveau 3 : Défi -----
    {
      ...
      generer() {
        ...
        return { enonce: `Triangle rectangle en $A$, hypoténuse $BC=${c}$, $AC=${b}$. Calcule $AB$ (au dixième).`, reponse: round1(Math.sqrt(c * c - b * b)), validation: 'nombre', tolerance: 0.05, visuel: (h) => pythagoreFig(h, { ab: '?', ac: String(b), bc: String(c) }), _v: { b, c } };
      },
