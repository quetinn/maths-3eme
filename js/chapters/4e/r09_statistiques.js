// =====================================================================
//  r09_statistiques.js — 4ᵉ : moyenne, étendue, effectifs
//  et fréquences.
...
export default {
  id: 'r09',
  titre: 'Statistiques',
  theme: 'donnees', niveau: '4e',
  priorite: false,
  icone: '📊',

  intro:
    "En 4ᵉ, on apprend à résumer une série de données : la moyenne, l'étendue, les effectifs et les fréquences. " +
    "Ces outils sont repris et complétés en 3ᵉ (médiane, quartiles, diagrammes en boîte). On travaille ici les " +
  ...
  exercices: [
    ...
    },
    {
      ...
      generer() { const data = Array.from({ length: 5 }, () => randInt(2, 18)); const s = data.reduce((a, b) => a + b, 0); return { enonce: `Série : $${data.join(' \\;;\\; ')}$. Calcule la moyenne.`, reponse: Math.round(s / 5 * 10) / 10, validation: 'nombre', tolerance: 0.05, _v: { data, s } }; },
