// =====================================================================
//  r10_probabilites.js — 4ᵉ : expérience aléatoire, probabilité
...
export default {
  ...
  intro:
    ...
    "(impossible) et $1$ (certain). On travaille le vocabulaire (issue, événement) et le calcul d'une probabilité " +
