// =====================================================================
//  r03_fractions.js — 4ᵉ : additionner, soustraire, multiplier
...
export default {
  ...
  intro:
    ...
    "On travaille ici les quatre opérations : additionner (même dénominateur, ou ramener au même), multiplier, " +
