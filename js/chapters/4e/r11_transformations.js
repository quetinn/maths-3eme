// =====================================================================
//  r11_transformations.js — 4ᵉ : symétrie axiale, symétrie
...
export default {
  id: 'r11',
  titre: 'Translation et symétries',
  ...
  intro:
    ...
    "de départ. On travaille la symétrie axiale (pliage), la symétrie centrale (demi-tour) et la translation " +
