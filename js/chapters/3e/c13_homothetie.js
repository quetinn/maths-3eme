  ...
  exercices: [
    ...
    },
    {
      ...
      generer() {
        ...
        return { enonce: `Un solide de volume $${V}$ cm³ est réduit de rapport $k = ${String(k).replace('.', '{,}')}$. Nouveau volume ?`, reponse: Math.round(V * k * k * k * 10) / 10, validation: 'nombre', tolerance: 0.05, _v: { V, k } };
      },
