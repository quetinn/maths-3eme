  ...
  exercices: [
    ...
    },
    {
      ...
      generer() {
        ...
        return { enonce: `Deux droites se croisent en $A$. $(MN)\\parallel(BC)$, $AM=${am}$, $AB=${ab}$, $BC=${cd}$. Calcule $MN$ (arrondi au centième si besoin).`, reponse: round2(cd * am / ab), validation: 'nombre', tolerance: 0.005, _v: { am, ab, cd } };
      },
