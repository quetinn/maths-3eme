...
export default {
  ...
  exercices: [
    ...
    },
    {
      ...
      generer() {
        ...
        return { enonce: `Cône de rayon $r = ${r}$ cm et hauteur $h = ${h}$ cm. Volume ?`, reponse: r1((1 / 3) * Math.PI * r * r * h), accepte: [r1((1 / 3) * 3.14 * r * r * h)], validation: 'nombre', tolerance: 0.05, _v: { r, h } };
      },
  ...
  quiz_bilan: [
    ...
    { type: 'saisie', question: 'Volume de la boule de rayon 3 cm (arrondi au dixième) ?', reponse: 113.1, accepte: [113.0], validation: 'nombre', tolerance: 0.05, explication: '$\\dfrac43 \\pi \\times 27 = 36\\pi \\approx 113{,}1$ cm³.' },
  ],
};
